...
export declare class V2Client {
     ...
     */
    chatStream(request: Cohere.V2ChatStreamRequest, requestOptions?: V2Client.RequestOptions): core.HttpResponsePromise<core.Stream<Cohere.V2ChatStreamResponse>>;
     ...
     *     })
     */
    chat(request: Cohere.V2ChatRequest, requestOptions?: V2Client.RequestOptions): core.HttpResponsePromise<Cohere.V2ChatResponse>;
    private __chat;
    /**
     ...
     *     })
     */
    parse(request: Cohere.ParseRequest, requestOptions?: V2Client.RequestOptions): core.HttpResponsePromise<Cohere.ParseResponse>;
    private __parse;
    /**
     ...
     *     })
     */
    embed(request: Cohere.V2EmbedRequest, requestOptions?: V2Client.RequestOptions): core.HttpResponsePromise<Cohere.EmbedByTypeResponse>;
    private __embed;
    /**
     ...
     *     })
     */
    rerank(request: Cohere.V2RerankRequest, requestOptions?: V2Client.RequestOptions): core.HttpResponsePromise<Cohere.V2RerankResponse>;
    private __rerank;
}
