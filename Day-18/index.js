...
const hybridSearchResults = await hybridSearch(question, queryEmbedding[0], 20);

// hybridSearchResults.forEach((r) =>
//   console.log(`  [${r.score.toFixed(4)}] ${r.content.slice(0, 80)}...`),
// );

const top5 = await reRankChunks(question, hybridSearchResults);


const answer = await generateAnswer(question, top5);
console.log(answer)
return {top5,answer}
