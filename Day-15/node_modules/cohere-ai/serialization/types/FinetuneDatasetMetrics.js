...
const ChatDataMetrics_1 = require("./ChatDataMetrics");
const ClassifyDataMetrics_1 = require("./ClassifyDataMetrics");
const RerankerDataMetrics_1 = require("./RerankerDataMetrics");
exports.FinetuneDatasetMetrics = core.serialization.object({
    ...
    rerankerDataMetrics: core.serialization.property("reranker_data_metrics", RerankerDataMetrics_1.RerankerDataMetrics.optional()),
    chatDataMetrics: core.serialization.property("chat_data_metrics", ChatDataMetrics_1.ChatDataMetrics.optional()),
    classifyDataMetrics: core.serialization.property("classify_data_metrics", ClassifyDataMetrics_1.ClassifyDataMetrics.optional()),
});
